...
=======================================================================================================================
"""
#Matrix defenieren # ACHTUNG: Für sinus/cosinus/Exponentialfunktion immer sy.sin/sy.cos/sy.exp/sy.ln/sy.abs verwenden!
f = sy.Matrix([
    x1 + x2**2 - x3**2 - 13,
...
# Wenn mehr oder weniger als 3 Variablen auftreten, diese Liste anpassen!
x = sy.Matrix([x1, x2, x3])

# Stelle, an welcher die Jacobi-Matrix ausgewertet werden soll, z.B. x0 bei Newton
x0 = sy.Matrix([3/2, 3, 5/2])
"""
=======================================================================================================================
"""
